 ...
 */
class RocketWeb_Netsuite_Block_Adminhtml_Status_Delete_Grid extends Mage_Adminhtml_Block_Widget_Grid {
	public function __construct()
	{
		parent::__construct();
		$this->setId('delete_status_grid');
	...
	protected function _prepareCollection()
	{
		...
		$collection->addFieldToFilter('queue_id',Mage::helper('rocketweb_netsuite/queue')->getQueueId(RocketWeb_Netsuite_Helper_Queue::NETSUITE_DELETE_QUEUE));
    ...
    protected function _prepareMassaction() {
        ...
        $this->getMassactionBlock()->addItem(
            'delete',
            array('label'=>'Delete',
                'url'  => $this->getUrl('*/*/massDeleteDelete'),
