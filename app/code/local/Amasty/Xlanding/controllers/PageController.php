...
//         Zend_Debug::dump($page->getBanner());die;
    ...
    {
    	if ($page->getIncludeNavigation() === Amasty_Xlanding_Model_Source_Navigation::INCLUDE_NO) {
    		return;
    	}
		...
		//Add Left Sidebar Title : Shop By
// 		echo "
// 		<div style='position:absolute; margin-left: 204px; margin-top: 232px;'>	
...
// 		";		
		...
		//Remove default magento navigation to replace with manadev
    	/*
    	 * Default Navigation
    	 */
