...
class MDN_AdminLogger_Block_Adminhtml_Sales_Order_View_Grid extends Mage_Adminhtml_Block_Widget_Grid implements Mage_Adminhtml_Block_Widget_Tab_Interface {
    ...
    public function __construct() {
        ...
        parent::__construct();
        $this->setId('AdminLoggerSalesGrid');
        $this->_parentTemplate = $this->getTemplate();
        $this->setTemplate('AdminLogger/Sales/Order/Grid.phtml');
