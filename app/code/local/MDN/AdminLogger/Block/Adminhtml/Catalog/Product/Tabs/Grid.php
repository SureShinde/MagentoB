...
class MDN_AdminLogger_Block_Adminhtml_Catalog_Product_Tabs_Grid extends Mage_Adminhtml_Block_Widget_Grid implements Mage_Adminhtml_Block_Widget_Tab_Interface {
    ...
    public function __construct() {
        ...
        parent::__construct();
        $this->setId('AdminLoggerProductGrid');
        ...
        $this->setVarNameFilter('adminlogger_product');
    }

    /**
     * Charge collection with filter for product infos
     *
     * @return unknown
     */
...
//                ->addFieldToFilter('al_object_type', array('like' => 'catalog/product'));
    ...
    public function getGridUrl() {
        return $this->getUrl('AdminLogger/Admin/ProductAjaxGrid', array('_current' => true));
    }
