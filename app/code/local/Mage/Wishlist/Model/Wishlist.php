...
class Mage_Wishlist_Model_Wishlist extends Mage_Core_Model_Abstract
{
    ...
    {
        $view = $this->_getData('view');
        return $view;
    }

    public function getWlid()
    {
        $wlid = $this->_getData('wishlist_id');
        return $wlid;
    }
    ...
    {
        return $this->setData($this->_getResource()->getDescFieldName(), $desc);
    }

    public function setCustomerIdDel($viewStatus)
    {
        return $this->setData($this->_getResource()->getViewFieldName(), $viewStatus);
    }
    ...
    {
        return $this->getData($this->_getResource()->getDescFieldName());
    }

    public function getCounter()
    {
        return $this->getData($this->_getResource()->getCountFieldName());
    }
