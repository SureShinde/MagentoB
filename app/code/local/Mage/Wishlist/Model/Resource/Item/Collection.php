...
class Mage_Wishlist_Model_Resource_Item_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    ...
    /*public function setViewFilter($flag = false)
    {
        $this->_productView = (bool)$flag;
        return $this;
    }*/

    /*public function viewWishlistFilter(Mage_Wishlist_Model_Wishlist $wishlist)
    {
        $filter = '1';
        $this->addFieldToFilter('view',$filter);
        return $this;
    }*/
