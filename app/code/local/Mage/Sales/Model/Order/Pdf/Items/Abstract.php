...
abstract class Mage_Sales_Model_Order_Pdf_Items_Abstract extends Mage_Core_Model_Abstract
{
     ...
     * @return Mage_Sales_Model_Order_Pdf_Items_Abstract
     */
    public function setItem(Varien_Object $item, $itemFromOrder=false)
    {
        $this->_item = $item;
        $this->_itemFromOrder = $itemFromOrder;
        return $this;
    }
    ...
    {
    	if($this->_itemFromOrder === true && $item->getProductOptionByCode('simple_sku')){
    		return $item->getProductOptionByCode('simple_sku');
    	}else if ($this->_itemFromOrder === false && $item->getOrderItem()->getProductOptionByCode('simple_sku')){
