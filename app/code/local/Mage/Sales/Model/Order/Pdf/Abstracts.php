 ...
 */
abstract class Mage_Sales_Model_Order_Pdf_Abstracts extends Varien_Object
{
    /**
     * Y coordinate
     *
...
//         	Zend_Debug::dump($totalInfo);
     ...
     * @return Zend_Pdf_Page
     */
    protected function _drawItem(Varien_Object $item, Zend_Pdf_Page $page, Mage_Sales_Model_Order $order, $itemFromOrder=false)
    {
        if($itemFromOrder===true){
        	$type = $item->getProductType();
        	$renderer = $this->_getRenderer($type);
        	
        	//TODO: XXX
        	$renderer->setItem($item, $itemFromOrder);
        }else{
