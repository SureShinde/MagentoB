...
class Mage_Review_Block_Product_View_List extends Mage_Review_Block_Product_View {
    ...
    protected function _prepareLayout() {
        ...
        if ($pager = $this->getLayout()->createBlock('page/html_pager', 'your.custom.blockname.pager')) {
            //call your own collection getter here, name it something better than getCollection, please; *or* your call to getResourceModel()
