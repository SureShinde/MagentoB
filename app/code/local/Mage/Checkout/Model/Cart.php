...
class Mage_Checkout_Model_Cart extends Varien_Object implements Mage_Checkout_Model_Cart_Interface
{
    ...
    public function addProduct($productInfo, $requestInfo=null)
    {
        ...
        $isCrossBorderItem = $crossBorderHelper->isCrossBorder($product);
        ...
        if ($product->getStockItem()) {
            ...
            if ($isCrossBorderItem) {
                try {
                    $crossBorderCheck = $crossBorderHelper->validateAddToCart($product, $request->getData('qty'), $this);
