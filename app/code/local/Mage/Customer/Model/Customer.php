...
class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
{
    ...
    /**
     * Send corresponding email template for logan front end
     *
     * @param string $emailTemplate configuration path of email template logan front end in config.xml
     * @param string $emailSender configuration path of email identity
     * @param array $templateParams
     * @param int|null $storeId
     * @return Mage_Customer_Model_Customer
    ...
    /**
     * Send email with reset password confirmation link for LoganFrontEnd apps
     *
     * @return Mage_Customer_Model_Customer
     */
