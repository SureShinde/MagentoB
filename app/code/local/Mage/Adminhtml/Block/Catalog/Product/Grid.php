<?php
/**
 * LOKAL Adminhtml customer grid block
 */
...
// 		)); 
		...
		/* -- Kolom Stock/Ketersediaan dari Inventory -- */ 
		$this->addColumn('stock_status',
            array(
                'header'=> 'Stock Status',     // judul kolom
                'width' => '60px',             // lebar kolom
                'index' => 'stock_status',
				'type'  => 'options',
		...
		/* -- Kolom Backorder dari Inventory -- */
		$this->addColumn('backorders',
            array(
                'header'=> 'Backorders',     // judul kolom
                'width' => '60px',           // lebar kolom
                'index' => 'backorders',
				'type'  => 'options',
                'options' => array(
