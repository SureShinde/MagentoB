    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        $usesPerCouponPerHouseholdFiled = $fieldset->addField('uses_per_household', 'text', array(
            'name' => 'uses_per_household',
            'label' => Mage::helper('salesrule')->__('Uses per Household'),
            'note' => Mage::helper('salesrule')->__('Max allowed fraud for same shipping address')
        ));
