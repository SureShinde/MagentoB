...
class AW_Followupemail_Model_Queue extends Mage_Core_Model_Abstract {
    ...
    public function add($code, $sequenceNumber, $senderName, $senderEmail, $recipientName, $recipientEmail, $ruleId, $scheduledAt, $subject, $content, $objectId, $params) {
        ...
        $message = "email added id={$this->getId()} seq.No=$sequenceNumber email=$recipientEmail name=$recipientName ruleId=$ruleId objectId=$objectId code=$code scheduledAt=$scheduledAt GMT subject=$subject";
