...
class AW_Marketsuite_Model_Rule_Condition_Combine extends Mage_Rule_Model_Condition_Combine
{
    ...
    public function getValidatedOrdersIds(Mage_Sales_Model_Resource_Order_Collection $orderCollection)
    {
    ...
    public function getValidatedCustomersIds(Mage_Customer_Model_Resource_Customer_Collection $customerCollection)
    {
        if (!$this->getConditions()) {
