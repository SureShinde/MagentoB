 ...
 * @author Naitik Shah <naitik@facebook.com>
 */
abstract class AW_Ajaxlogin_Model_BaseFacebook
{
  /**
   * Version.
   */
  ...
  public function __construct($config) {
    ...
    $this->setAppSecret(isset($config['secret']) ? $config['secret'] : null);
 ...
 */
class AW_Ajaxlogin_Model_Facebook extends AW_Ajaxlogin_Model_BaseFacebook
{
