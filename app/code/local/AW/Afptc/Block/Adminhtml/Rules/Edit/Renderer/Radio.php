    ...
    extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Radio
{
    public function render(Varien_Object $row)
    {
        ...
        $html = '<input onclick="awAfptcGridJsObject.reloadParams = {}; awAfptcGridJsObject.reloadParams.checkedValues = this.value" type="radio" name="' . $this->getColumn()->getHtmlName() . '" ';
