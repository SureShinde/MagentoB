...
{   
    ...
    public function toOptionArray()
    {
        ...
        $this->_collection->addFieldToFilter('active_from', array('lteq' => Mage::getModel('core/date')->date('Y-m-d')));
        $this->_collection->addFieldToFilter('active_to', array('gteq' => Mage::getModel('core/date')->date('Y-m-d')));
