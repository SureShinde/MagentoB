...
class AW_Customerattributes_Model_Attribute_Type_Textarea extends AW_Customerattributes_Model_Attribute_TypeAbstract
{
    /**
     * @return AW_Customerattributes_Block_Widget_Backend_Grid_Textarea
     */
    protected function _getBackendGridRenderer()
    {
        return new AW_Customerattributes_Block_Widget_Backend_Grid_Textarea();
    }

    /**
     * @return AW_Customerattributes_Block_Widget_Backend_Form_Textarea
     */
    protected function _getBackendFormRenderer()
    {
        return new AW_Customerattributes_Block_Widget_Backend_Form_Textarea();
    }

    /**
     * @return AW_Customerattributes_Block_Widget_Frontend_Form_Textarea
     */
    protected function _getFrontendFormRenderer()
    {
        return new AW_Customerattributes_Block_Widget_Frontend_Form_Textarea();
    }
