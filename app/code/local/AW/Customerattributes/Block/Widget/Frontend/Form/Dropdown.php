...
class AW_Customerattributes_Block_Widget_Frontend_Form_Dropdown
    extends AW_Customerattributes_Block_Widget_Frontend_FormAbstract
{
    ...
    private function _getOptionsForSelect()
    {
        ...
        $options = Mage::helper('aw_customerattributes/options')->getOptionsForAttributeByStoreId($attribute, $storeId);
