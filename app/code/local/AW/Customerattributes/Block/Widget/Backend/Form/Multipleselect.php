...
class AW_Customerattributes_Block_Widget_Backend_Form_Multipleselect
    extends AW_Customerattributes_Block_Widget_Backend_FormAbstract
{
    ...
    private function _getOptionsForSelect()
    {
        ...
        return Mage::helper('aw_customerattributes/options')
            ->getOptionsForAttributeByStoreIdAsArray($attribute, $storeId, false);
    }
}