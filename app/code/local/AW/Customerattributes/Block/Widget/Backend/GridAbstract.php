...
abstract class AW_Customerattributes_Block_Widget_Backend_GridAbstract
    implements AW_Customerattributes_Block_Widget_Backend_GridInterface
{
    /**
     ...
     *
     * @return AW_Customerattributes_Block_Widget_Backend_GridAbstract
     */
