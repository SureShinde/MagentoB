...
class AW_Points_Model_Rule_Condition_Combine extends Mage_Rule_Model_Condition_Combine {
    ...
    public function getNewChildSelectOptions() {
        ...
        $conditions = array_merge_recursive($conditions, array(
            array('value' => 'points/rule_condition_product_found', 'label' => $helper->__('Product attribute combination')),
            array('value' => 'points/rule_condition_product_subselect', 'label' => $helper->__('Products subselection')),
            array('value' => 'points/rule_condition_combine', 'label' => $helper->__('Conditions combination')),
