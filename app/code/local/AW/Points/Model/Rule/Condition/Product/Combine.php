...
class AW_Points_Model_Rule_Condition_Product_Combine extends Mage_Rule_Model_Condition_Combine {
    ...
    public function getNewChildSelectOptions() {
        ...
        $conditions = array_merge_recursive($conditions, array(
            array('value' => 'points/rule_condition_product_combine', 'label' => Mage::helper('catalog')->__('Conditions Combination')),
            array('label' => Mage::helper('points')->__('Cart Item Attribute'), 'value' => $iAttributes),
            array('label' => Mage::helper('points')->__('Product Attribute'), 'value' => $pAttributes),
                ));
        return $conditions;
    }
