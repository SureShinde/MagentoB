            ...
            try {
                ...
                foreach ($this->_appliedRules as $rule) {
                	if($rule->getApplyOn() == "cart_fixed"){
                		...
                		$extraPointToBeAdd = (int)$this->_quote->getItemsQty() * $rule->getPointsChange();
                	}else if($rule->getApplyOn() == "by_percent"){
                		$extraPointToBeAdd = ($this->_quote->getSubtotal() * $rule->getPointsChange()) / 100;
                	}else if($rule->getApplyOn() == "by_percent_product" || $rule->getApplyOn() == "by_fixed_product"){
