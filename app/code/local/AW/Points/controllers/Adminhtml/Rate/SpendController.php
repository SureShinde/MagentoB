...
class AW_Points_Adminhtml_Rate_SpendController extends Mage_Adminhtml_Controller_Action {

    protected function displayTitle() {
        if (!Mage::helper('points')->magentoLess14())
            $this->_title($this->__('Rewards'))->_title($this->__('Spend Rates'));
        return $this;
    }
    ...
    public function indexAction() {
        $this
                ...
                ->_addContent($this->getLayout()->createBlock('points/adminhtml_rate_spend'))
                ->renderLayout();
    }
    ...
    public function editAction() {
        ...
        $this
                ...
                ->loadLayout()
                ->_setActiveMenu('promo')
                ->_addContent($this->getLayout()->createBlock('points/adminhtml_rate_spend_edit'))
                ->renderLayout();
    }
    ...
    protected function _isAllowed() {
        return Mage::getSingleton('admin/session')->isAllowed('promo/points/points_rates/spend_rate');
    }
