 ...
 */
class MP_MaxCouponDiscountAmount_Adminhtml_Block_Promo_Quote_Edit_Tab_Actions
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('max_discount_amount', 'text', array(
            ...
            'required' => false,
            'class' => 'validate-not-negative-number',
            'label' => Mage::helper('salesrule')->__('Max Discount Amount (currency)'),
        ));
        $model->setMaxDiscountAmount($model->getMaxDiscountAmount()*1);
