 ...
 */
class Bilna_Sales_Model_Api2_Order extends Mage_Api2_Model_Resource
{
    /**#@+
    ...
    protected function _retrieveCollection() {
        ...
        foreach ($collection->getItems() as $order) {
            ...
            if (isset ($ordersData[$order->getId()]['created_at'])) {
                $ordersData[$order->getId()]['created_at'] = date('Y-m-d H:i:s', Mage::getModel('core/date')->timestamp($ordersData[$order->getId()]['created_at']));
                $ordersData[$order->getId()]['created_at'] = Mage::getModel('core/date')->date($ordersData[$order->getId()]['created_at']);
            }
        }
