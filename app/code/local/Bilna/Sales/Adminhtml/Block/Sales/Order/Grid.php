 ...
 * @copyright   Copyright (c) 2013 PT. Bilna. (http://www.bilna.com/)
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */

/**
 * LOKAL Adminhtml sales orders grid
 *
 * @category   Mage
 * @package    Mage_Adminhtml
 * @author     Andhi Irawan <andhiirawan@inbox.com> . 20092013
 */
class Bilna_Sales_Adminhtml_Block_Sales_Order_Grid extends Mage_Adminhtml_Block_Sales_Order_Grid
{
