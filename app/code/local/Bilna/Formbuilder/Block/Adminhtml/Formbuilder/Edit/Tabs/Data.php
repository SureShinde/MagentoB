...
class Bilna_Formbuilder_Block_Adminhtml_Formbuilder_Edit_Tabs_Data extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareCollection()
  {
		...
		$collection->getSelect()
			->join(array('bff' => 'bilna_formbuilder_input'), 'main_table.form_id = bff.form_id AND main_table.type = bff.name',array('main_table.record_id', 'main_table.form_id', 'main_table.create_date')); //bilna_formbuilder_input
		$collection->getSelect()
