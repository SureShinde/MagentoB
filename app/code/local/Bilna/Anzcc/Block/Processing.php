...
class Bilna_Anzcc_Block_Processing extends Mage_Payment_Block_Info {
    private $_code = 'anzcc';
    ...
    protected function getPromoBinsSingle($entityId) {
        return Mage::getModel('anzcc/anzcc')->getCCBinsByEntityId($entityId);
    }
    
    protected function getPromoBins() {
        $issuer = (string) Mage::getStoreConfig('payment/anzcc/issuer');
        $promoBins = Mage::getModel('anzcc/bincode')
            ->getCollection()
