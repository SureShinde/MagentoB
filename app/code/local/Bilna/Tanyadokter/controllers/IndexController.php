<?php
class Bilna_Tanyadokter_IndexController extends Mage_Core_Controller_Front_Action 
{
	...
	public function submitAction() {
		...
		if ($insertData) {
			...
			$redirectPage = Mage::getBaseUrl().'tanya-ahli';
	...
	private function _prepareEmail($name, $email, $phone, $comment, $templateId) {
        $emailVars = array (
            ...
            'phone' => $phone,
            'comment' => $comment,
			'name_to' => 'Tanya Dokter',
			'email_to' => 'tanyadokter@bilna.com'
        );
	...
	private function _insertData() {
        ...
        $sql = "insert into tanyadokter (name, email, phone, comment, submit_date) values (?,?,?,?, ?)";
