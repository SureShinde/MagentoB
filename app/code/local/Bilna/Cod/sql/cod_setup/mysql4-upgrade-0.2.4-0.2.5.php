...
// BEGIN - Create cod attribute
$installer = Mage::getResourceModel('catalog/setup', 'catalog_setup');
$installer->addAttribute('catalog_product', 'cod', array(
    'global' => Mage_Catalog_Model_Resource_Eav_Attribute::SCOPE_GLOBAL,
    'input' => 'boolean',
    'type' => 'int',
    'source' => 'eav/entity_attribute_source_boolean',
    'label' => 'Available for Cash On Delivery (COD)',
    'default' => '0',
    'required'=>'0',
    'comparable'=>'0',
    'searchable'=>'0',
...
$installer->endSetup();
// END - Create cod attribute

// BEGIN - Assign 'cod' Attribute to group 'General' for All Attribute Sets
...
// END - Assign 'cod' Attribute to group 'General' for All Attribute Sets