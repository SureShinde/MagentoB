<?php
/**
 * Description of Mage_Catalog_Model_Api2_Product_Rest
 *
...
abstract class Bilna_Rest_Model_Api2_Product_Rest extends Bilna_Rest_Model_Api2_Product {
     ...
     * Product Images
     */
    protected $_imgThumbnail = 60;
    protected $_imgHorizontal = 80;
    protected $_imgVertical = 150;
    protected $_imgDetail = 360;
