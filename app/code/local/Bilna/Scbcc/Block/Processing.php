...
class Bilna_Scbcc_Block_Processing extends Mage_Payment_Block_Info {
    private $_code = 'scbcc';
    ...
    protected function getPromoBinsSingle($entityId) {
        return Mage::getModel('scbcc/scbcc')->getCCBinsByEntityId($entityId);
    }
    
    protected function getPromoBins() {
        $issuer = (string) Mage::getStoreConfig('payment/scbcc/issuer');
        $promoBins = Mage::getModel('scbcc/bincode')
            ->getCollection()
