...
class Bilna_Promo_Adminhtml_GimmickeventController extends Mage_Adminhtml_Controller_action
{
	protected function _initAction() {
		$this->loadLayout()
			->_setActiveMenu('bilna/bilnapromo')
			->_addBreadcrumb(Mage::helper('adminhtml')->__('Gimmick Event'), Mage::helper('adminhtml')->__('Gimmick Event'));
