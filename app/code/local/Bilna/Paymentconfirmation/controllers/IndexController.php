...
DEFINE('SUCCESS','Konfirmasi pembayaran anda telah kami terima. kami akan melakukan pengecekan. Mohon simpan bukti pembayaran anda, jika diperlukan tim kami akan menghubungi anda untuk pengecekan lebih lanjut, jika anda melakukan kesalahan saat memasukkan data konfirmasi, silahkan hubungi <a href="mailto:cs@orami.co.id">cs@orami.co.id</a><br><br>Mohon tunggu maksimal 24 jam, Anda akan menerima e-mail status pesanan dari kami.');
...
DEFINE('DUPLICATE_ORDER','Pesanan telah berhasil dikonfirmasi sebelumnya. Apabila Anda ingin mengubah informasi yang telah diterima, silakan menghubungi <a href="mailto:cs@orami.co.id">cs@orami.co.id</a>');
