...
class Bilna_Megamenu_Model_Observer_Catalog_Category extends Mage_Catalog_Model_Observer {
    protected function _addCategoriesToMenu($categories, $parentCategoryNode, $menuBlock, $addTags = false) {
        ...
        foreach ($categories as $category) {
            ...
            $categoryData = array (
                ...
                'megamenu_static_block' => $category->getData('megamenu_static_block'),
    ...
    public function productDelete($observer) {
        ...
        if ($collections->count()) {
            ...
            throw Mage::exception('Mage_Core', $name . Mage::helper('eav')->__(' product is used as a featured product for Catagory ') . $categoryName);
        }
