...
class Bilna_Customreports_Block_Processing extends Mage_Payment_Block_Info {
    private $_code = 'customreports';
    ...
    protected function getPromoBinsSingle($entityId) {
        return Mage::getModel('customreports/installmentreport')->getCCBinsByEntityId($entityId);
    }
    
    protected function getPromoBins() {
        $issuer = (string) Mage::getStoreConfig('payment/customreports/issuer');
        $promoBins = Mage::getModel('customreports/bincode')
            ->getCollection()
