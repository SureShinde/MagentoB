...
class Bilna_Customreports_Model_Installmentreport extends Mage_Payment_Model_Method_Abstract {
    protected $_code = 'customreports';
    protected $_formBlockType = 'customreports/form_anzcc';
    protected $_infoBlockType = 'customreports/info_anzcc';
    ...
    public function getOrderPlaceRedirectUrl() {
        return Mage::getUrl('customreports/processing', array ('_secure' => true));
    }
