    ...
    {% if newsletterShow == true %}
        <div class="row footer-subscribe">
            <p class="col-lg-8 col-md-8">
                {{ t._('Don’t want miss every single deals? Enter your email here') }}
            </p>

            <form id="newsletter-subscribe-footer" class="col-lg-4 col-md-4">
                <input type="text" id="newsletter-email" name="newsletter-email" class="col-lg-8 col-md-8" placeholder="{{ t._('Enter your email') }}" value="{{ newsletterValue }}" />
                <button type="submit" class="col-lg-4 col-md-4">{{ t._('Submit') }}</button>
            </form>
        </div>
    {% endif %}
