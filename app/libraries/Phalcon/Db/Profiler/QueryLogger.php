<?php
namespace Bilna\Phalcon\Db\Profiler;
...
class QueryLogger
{
    ...
    public function __construct(
        ...
        if (!$this->logger) {
            ...
            $this->logger = new \Phalcon\Logger\Adapter\File(tempnam(sys_get_temp_dir(), 'dbXXXX.log'));
        }
     ...
     * @return $this
     */
    public function setLogger(\Phalcon\Logger\Adapter\File $logger)
    {
        $this->logger = $logger;
        return $this;
    }
