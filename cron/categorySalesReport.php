...
foreach($colls as $coll){
 	$senderEmail = $coll->getSenderEmail();
	$senderName = $coll->getSenderName();
	$receiverEmail = explode(',', $coll->getReceiverEmail());
	$version = $coll->getVersion();
}
*/

$senderEmail = 'tickets@bilna.com';
$senderName = 'Tickets Bilna';
$receiverEmail = array("indra.kurniawan@bilna.com", "taufik.r@bilna.com", "ferry.lukito@bilna.com", "uke.m@bilna.com");
$version = 'prod';
