            ...
            if ( __frame.type == AjaxLogin.Authorization.FRAMETYPE_LOGIN ) {
                ...
                __frame.login = function (authorizationInstance) {
                    return function(validationResult) {
                        ...
                        __parameters = {};
                        this.loginFormNode.getElements().each(
                            function(element) {
                                if ( (typeof element.type != 'undefined') && (element.type == 'checkbox') ) {
                                    if ( element.checked ) __parameters[element.name] = element.value;
                                }
                                else __parameters[element.name] = element.value;
                            }
                        );
                ...
                __frame.registrationFormNode.observe(
                    ...
                    function(frameInstance) {
                        return function(event) {
                            ...
                            __parameters = {};
                            frameInstance.registrationFormNode.getElements().each(
                                function(element) {
                                    if ( (typeof element.type != 'undefined') && (element.type == 'checkbox') ) {
                                        if ( element.checked ) __parameters[element.name] = element.value;
                                    }
                ...
                __frame.recoveryFormNode.observe(
                    ...
                    function(frameInstance) {
                        return function(event) {
                            ...
                            __parameters = {};
                            frameInstance.recoveryFormNode.getElements().each(
                                function(element) {
                                    if ( (typeof element.type != 'undefined') && (element.type == 'checkbox') ) {
                                        if ( element.checked ) __parameters[element.name] = element.value;
                                    }
            ...
            if ( __frame.type == AjaxLogin.Authorization.FRAMETYPE_EXTRA ) {
                ...
                __frame.login = function(authorizationInstance) {
                    return function(parameters, callbackFunction) {
                        ...
                        if ( __frame.loginFormNode ) {
                            __frame.loginFormNode.getElements().each(
                                function(element) {
                                    if ( (typeof element.type != 'undefined') && (element.type == 'checkbox') ) {
                                        if ( element.checked ) __parameters[element.name] = element.value;
                                    }
                                ...
                                if ( (typeof __force != 'undefined') && (__force) ) {
                                    while ( __selection.lastIndexOf(' ') > -1 ) {
                                        ...
                                        if ( __parentNodes.length ) {
                                            ...
                                            __parentSelection.insert(__node);
                                            if ( (typeof __inner != 'undefined') && (__inner) ) {
