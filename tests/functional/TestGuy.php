...
class TestGuy extends \Codeception\Actor
{
    ...
    * Conditional Assertion: Test won't be stopped on fail
    ...
    public function setRecord($model, $attributes = null) {
    ...
    * Conditional Assertion: Test won't be stopped on fail
    ...
    public function canSeeRecord($model, $attributes = null) {
        return $this->scenario->addStep(new \Codeception\Step\ConditionalAssertion('seeRecord', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
    ...
    public function seeRecord($model, $attributes = null) {
        return $this->scenario->addStep(new \Codeception\Step\Assertion('seeRecord', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
    ...
    * Conditional Assertion: Test won't be stopped on fail
    ...
    public function cantSeeRecord($model, $attributes = null) {
        return $this->scenario->addStep(new \Codeception\Step\ConditionalAssertion('dontSeeRecord', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
    ...
    public function dontSeeRecord($model, $attributes = null) {
        return $this->scenario->addStep(new \Codeception\Step\Assertion('dontSeeRecord', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
    ...
    public function getRecord($model, $attributes = null) {
        $model = (new \Codeception\Step\Action('grabRecord', func_get_args()))->run();
    ...
    public function amOnPage($page) {
        return $this->scenario->addStep(new \Codeception\Step\Condition('amOnPage', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
    ...
    * Conditional Assertion: Test won't be stopped on fail
    ...
    public function dontSee($text, $selector = null) {
        return $this->scenario->addStep(new \Codeception\Step\Assertion('dontSee', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
    ...
    * Conditional Assertion: Test won't be stopped on fail
    ...
    public function sendAjaxPostRequest($uri, $params = null) {
        ...
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep(new \Codeception\Step\Action('sendAjaxPostRequest', func_get_args()));
            return new Maybe($result);
        }
        return new Maybe();
    }
    ...
    * Conditional Assertion: Test won't be stopped on fail
    ...
    public function cantSeeElement($selector) {
        return $this->scenario->addStep(new \Codeception\Step\ConditionalAssertion('dontSeeElement', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
    ...
    * Conditional Assertion: Test won't be stopped on fail
    ...
    public function seeResponseIsJson() {
		return $this->scenario->runStep(new \Codeception\Step\Action('seeResponseIsJson', func_get_args()));
    }
    
	public function seeResponseContainsJson($expectedResponse) {
		return $this->scenario->runStep(new \Codeception\Step\Action('seeResponseContainsJson', func_get_args()));
    }
	
	public function assertEquals($expectedResponse) {
		return $this->scenario->runStep(new \Codeception\Step\Action('assertEquals', func_get_args()));
    }
	
	public function assertGreaterThan($expectedResponse) {
